...
edam_operations <- edam_operations[order(-N)] |> head(9)
edam_topics     <- edam_topics[order(-N)] |> head(9)
...
save_plot(a_2, "../docs/extended/extended_figure_5", 20, 10)
save_plot(multi, "../docs/extended/supplementary_figure_4", 12, 8)

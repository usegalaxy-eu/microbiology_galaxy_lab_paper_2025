...
# ggsave(
#     plot = multi, filename = paste0(outfolder, "/extended_data_figure_1.png"),
#     width = 9, height = 10, units = "in", dpi = 600
# )
# 
# ggsave(
#     plot = multi, filename = paste0(outfolder, "/extended_data_figure_1.svg"),
#     width = 9, height = 10, units = "in", dpi = 600
# )
# 
# ggsave(
#     plot = multi, filename = paste0(outfolder, "/extended_data_figure_1.pdf"),
